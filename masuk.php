...
<html lang="en">
    <head>
        ...
        <title>Barang Masuk - RIA STORE</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Selamat datang di website penjualan RIA STORE</li>
                        </ol>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; riadona</div>
                        </div>
                    </div>
                </footer>
            </div>
